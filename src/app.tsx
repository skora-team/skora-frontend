      ...
      <nav className="fixed top-0 left-0 right-0 w-full h-20 bg-[#1c1a1a] flex items-center justify-between px-10 z-50">
        <div className="flex items-center gap-10">
          <div className="flex items-center gap-8 cursor-pointer">
            <img
              src="/coin.png"
              className="w-[32px] h-[45px] image-render transition-transform duration-700 hover:-translate-y-1 hover:rotate-[360deg] gap-1"
              alt="coin"
            />
  ...
  Sign Up
      ...
      <main className="pt-20">
        ...
        >
          {/* Background GIF */}
          <img
            src="/bg1.gif" // <-- file should be in /public/bg1.gif
            className="absolute inset-0 w-full h-full object-cover"
            alt="Hero background"
          />

          {/* Fade from GIF to beige section */}
          ...
          <div className="relative z-10 text-center max-w-2xl text-white flex flex-col items-center gap-4">
            {/* Text GIF for "Coding Adventure" */}
            <img
              src="/LandingPage_Text.gif" // <-- file in /public/LandingPage_Text.gif
        ...
        <section className="bg-[#e6ccad] py-16 px-5">
          <div className="flex flex-col items-center justify-center text-center gap-5 mb-10">
            ...
            <CourseCard
              ...
              level="Beginner"
              image="/beach.gif" // make sure this is in /public
            />
          </div>
