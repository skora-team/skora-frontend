...
export function CoursePage() {
  ...
  return (
    <DashboardLayout>
      <Link to="/" className="inline-flex items-center text-[var(--text-muted)] hover:text-[var(--accent)] mb-8"><ChevronLeft size={20} /><span className="font-pixel text-xs ml-2">RETURN TO BASE</span></Link>
